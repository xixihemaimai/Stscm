...
//            }];
            ...
            [RSNetworkTool netWorkToolWebServiceDataUrl:URL_IMAGE_GET_IOS andType:@"GET" withParameters:phone andURLName:URL_IMAGE_GET_IOS andContentType:@"JSON" withBlock:^(id  _Nonnull responseObject, BOOL success) {
                        ...
                        [RSNetworkTool netWorkToolWebServiceDataUrl:URL_LOGIN_CODE_SEND_IOS andType:@"GET" withParameters:phoneNumber andURLName:URL_LOGIN_CODE_SEND_IOS andContentType:@"JSON" withBlock:^(id  _Nonnull responseObject, BOOL success) {
                           NSLog(@"------11112222------------------------000000---------------------------%@",responseObject);
                        }];
                   };
               }];
        }
