    ...
    if ([_tyle isEqualToString:@"huangliao"]) {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                ...
                [publishBtn setImage:[UIImage imageNamed:@"荒料入库"] forState:UIControlStateNormal];
            }else if (i == 1){
                [publishBtn setTitle:@"荒料出库" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"荒料出库"] forState:UIControlStateNormal];
            }else if (i == 2){
                [publishBtn setTitle:@"库存管理" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"库存管理"] forState:UIControlStateNormal];
            }else{
                [publishBtn setTitle:@"报表中心" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"报表中心"] forState:UIControlStateNormal];
            }
        ...
        for (int i = 0; i < 4; i++) {
            ...
            if (i == 0) {
                ...
                [publishBtn setImage:[UIImage imageNamed:@"大板入库"] forState:UIControlStateNormal];
            }else if (i == 1){
                [publishBtn setTitle:@"大板出库" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"大板出库"] forState:UIControlStateNormal];
            }else if (i == 2){
                [publishBtn setTitle:@"库存管理" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"库存管理(1)"] forState:UIControlStateNormal];
            }else{
                [publishBtn setTitle:@"报表中心" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"报表中心(1)"] forState:UIControlStateNormal];
            }
            [publishBtn setTitleColor:[UIColor colorWithHexColorStr:@"#282D38"] forState:UIControlStateNormal];
            if (iPhone5) {
                publishBtn.titleLabel.font = [UIFont systemFontOfSize:12];
...
//            }else if (i == 1){
                ...
                [publishBtn setImage:[UIImage imageNamed:@"物料字典"] forState:UIControlStateNormal];
            }else if (i == 1){
                [publishBtn setTitle:@"仓库管理" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"仓库管理"] forState:UIControlStateNormal];
            }else if (i == 2){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (i == 0) {
                ...
                [publishBtn setImage:[UIImage imageNamed:@"用户管理"] forState:UIControlStateNormal];
            }else if (i == 1){
                [publishBtn setTitle:@"角色管理" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"角色管理"] forState:UIControlStateNormal];
            }
            else{
                [publishBtn setTitle:@"码单模板" forState:UIControlStateNormal];
                [publishBtn setImage:[UIImage imageNamed:@"码单模版"] forState:UIControlStateNormal];
            }
            [publishBtn setTitleColor:[UIColor colorWithHexColorStr:@"#282D38"] forState:UIControlStateNormal];
            if (iPhone5) {
                publishBtn.titleLabel.font = [UIFont systemFontOfSize:12];
