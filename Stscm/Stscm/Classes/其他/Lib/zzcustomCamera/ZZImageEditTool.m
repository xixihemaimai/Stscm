...
-(void)initUI
{
    self.backgroundColor = [UIColor colorWithHexColorStr:@"#333333"];
    ...
    bottomView.backgroundColor = [UIColor colorWithHexColorStr:@"#666666" alpha:0.9];
    ...
    UIButton *saveBtn = [UIButton zz_buttonWithTitle:nil imageName:@"home_customCamera_save" target:self action:@selector(save)];
    ...
    /// 关闭
    UIButton *closeBtn = [UIButton zz_buttonWithTitle:nil imageName:@"home_customCamera_close" target:self action:@selector(close)];
...
- (void)setImageViewFrame
{
    ...
    CGRect frame = CGRectMake((SCW - w) * 0.5, (maxH - h) * 0.5 + 10, w, h);
