...
- (UIImageView *)rightImageView {
    if(!_rightImageView) {
        //三角形 copy 2  反向
        _rightImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"三角形"]];
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        _tableView.layer.borderColor = [UIColor colorWithHexColorStr:@"#999999"].CGColor;
        _tableView.layer.borderWidth = 0.3;
        _tableView.separatorColor = [UIColor colorWithHexColorStr:@"#999999"];
